...
acquisition_data <- vroom(
  file       = "DS_101/02_data_wrangling/loan_data/loan_data/Acquisition_2019Q1.txt", 
  delim      = "|", 
...
performance_data <- vroom(
  file       = "DS_101/02_data_wrangling/loan_data/loan_data/Performance_2019Q1.txt", 
  delim      = "|", 
...
# only one way needed, but keep both in here for now
...
# again in following deply and datatable commands where used
